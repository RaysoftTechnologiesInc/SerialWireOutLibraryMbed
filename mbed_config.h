...
#define CLOCK_SOURCE                                                          USE_PLL_HSE_XTAL|USE_PLL_HSI                                                                     // set by target:URAPTOR_BASEBOARD
#define CLOCK_SOURCE_USB                                                      1                                                                                                // set by target:URAPTOR_BASEBOARD
#define HSE_VALUE                                                             26000000                                                                                         // set by target:URAPTOR_BASEBOARD
...
#define MBED_CONF_SWO_CPU_CORE_FREQHZ                                         100000000                                                                                        // set by library:SWO
#define MBED_CONF_SWO_DEFAULT_ENABLED_CHANNELS                                0xFFFFFFFF                                                                                       // set by library:SWO
#define MBED_CONF_SWO_SWO_SPEED                                               115200                                                                                           // set by library:SWO
#define MBED_CONF_SWO_TOTAL_CHANNEL_NUMBER                                    32                                                                                               // set by library:SWO
#define MBED_CONF_SYSTEMCLOCK_VECTOR_TABLE_OFFSET                             0x00                                                                                             // set by library:systemClock
